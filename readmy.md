...
- notify_if_strong_fluctuations(data, threshold): Функция  вычисляет максимальное и минимальное значения цены закрытия и сравнивать разницу с заданным порогом. Если разница превышает порог, пользователь получает уведомление.
- export_data_to_csv(data, filename: Функция которая позволяет сохранять загруженные данные об акциях в CSV файл.
...
<p align="center">
 <img width="700px" src="GOOGL_1y_stock_price_chart.png" alt="qr"/>
</p>
